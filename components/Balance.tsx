...
export default function Balance() {
    ...
    return (
        <section className="w-full h-84 border-1 border-white bg-[rgba(10,15,25,0.5)] rounded-2xl px-8 py-8 flex flex-col gap-4">
            <div className="flex justify-between">
                ...
                <button className="w-48 h-9 rounded-full border-1 ">
                    <span className="p-2 flex items-center justify-center gap-1 w-full h-full rounded-full border-2 border-[#3EAFF7] text-sm">
