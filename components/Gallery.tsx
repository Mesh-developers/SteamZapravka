    ...
    return (
        <section className="w-full h-95 border-1 border-(--border) bg-(--section-back) rounded-3xl lg:p-8 md:p-4 flex flex-col gap-8">
            <div className="flex gap-2 items-center">
                <Icon type="grid" />
                <h1 className="lg:text-4xl md:text-2xl">Все игры</h1>
            </div>
            <div className="flex gap-4 justify-between items-center h-full">
                ...
                <div className="flex lg:gap-2 md:gap-5 w-full h-full justify-between">
                    ...
                    className={`hover:translate-y-[-10px] bg-cover bg-no-repeat bg-center relative cursor-pointer w-48 lg:h-full md:h-65 rounded-2xl overflow-hidden border-1 border-(--border) hover:shadow-[3px_-3px_10px_0_#46F9D7,-3px_-3px_10px_0px_#46F9D7,3px_3px_10px_0_#15B5ED,-3px_3px_10px_0_#15B5ED]`}
                    />)}
                </div>
