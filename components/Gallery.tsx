...
export default function Gallery() {
    ...
    return (
        <section className="w-full h-95 border-1 border-(--border) bg-(--section-back) rounded-3xl lg:p-8 p-4 flex flex-col gap-8">
            ...
            <div className="flex gap-4 justify-between items-center h-full">
                ...
                <div className="flex lg:gap-2 gap-5 w-full h-full justify-between">
                    ...
                    className={`hover:translate-y-[-10px] bg-cover bg-no-repeat bg-center relative cursor-pointer lg:w-48 md:w-45 max-[768px]:w-43 lg:h-full h-65 rounded-2xl overflow-hidden border-1 border-(--border) hover:shadow-[3px_-3px_10px_0_#46F9D7,-3px_-3px_10px_0px_#46F9D7,3px_3px_10px_0_#15B5ED,-3px_3px_10px_0_#15B5ED]`}
                    />)}
                </div>
